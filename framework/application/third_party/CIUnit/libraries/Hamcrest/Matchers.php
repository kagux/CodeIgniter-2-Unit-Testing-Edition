...
require_once CIUPATH. 'libraries/Hamcrest/Core/AllOf.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/AnyOf.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/CombinableMatcher.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/DescribedAs.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/Every.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/Is.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsAnything.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsCollectionContaining.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsEqual.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsInstanceOf.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsNot.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsNull.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsIdentical.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsSame.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsSet.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/IsTypeOf.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/StringContains.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/StringEndsWith.php';
require_once CIUPATH. 'libraries/Hamcrest/Core/StringStartsWith.php';
require_once CIUPATH. 'libraries/Hamcrest/Number/IsCloseTo.php';
require_once CIUPATH. 'libraries/Hamcrest/Number/OrderingComparison.php';
require_once CIUPATH. 'libraries/Hamcrest/Text/IsEmptyString.php';
require_once CIUPATH. 'libraries/Hamcrest/Text/IsEqualIgnoringCase.php';
require_once CIUPATH. 'libraries/Hamcrest/Text/IsEqualIgnoringWhiteSpace.php';
require_once CIUPATH. 'libraries/Hamcrest/Text/MatchesPattern.php';
require_once CIUPATH. 'libraries/Hamcrest/Text/StringContainsInOrder.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsArray.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsBoolean.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsDouble.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsInteger.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsObject.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsResource.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsScalar.php';
require_once CIUPATH. 'libraries/Hamcrest/Type/IsString.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArray.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayContaining.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayContainingInAnyOrder.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayContainingInOrder.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayWithSize.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayContainingKey.php';
require_once CIUPATH. 'libraries/Hamcrest/Array/IsArrayContainingKeyValuePair.php';
require_once CIUPATH. 'libraries/Hamcrest/Collection/IsTraversableWithSize.php';
require_once CIUPATH. 'libraries/Hamcrest/Xml/HasXPath.php';
