...
//load Controller Testing
require_once CIUPATH . 'libraries/CIUnitControllerTestCase.php';

//load Models Testing
require_once CIUPATH . 'libraries/CIUnitModelTestCase.php';
...
function headers(){
    return CIUnit::$controller->output->get_headers();
}
